...
# Legends
# These legends were created using file "ABCM Process Map Legends Code.R "

periodic_norm <-  readPNG( "Legend Normative.png")
norm_LEG_height <- 15.444
nrom_LEG_width <- 11

periodic_normpat <- readPNG( "Legend Patient Normative Combo.png")
...
# Read in Data
input_clean <- read.csv("Anonymized Example Data.csv")
...
# Now, you want to match up each Intervention_Full and Description  from your input data with the names used in the Normative order data set "Normative Process Map Data.csv"
# You can copy and paste each line into columns G and H of "Normative Process Map Data.csv"
...
# In the CSV, "Normative Process Map Data.csv", the first 6 columns represent each normative process.  
